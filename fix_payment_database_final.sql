-- Final Payment Database Fix
-- This script handles existing fields gracefully

-- Add payment fields to memberships table (ignore if already exist)
...
-- Add payment fields to users table (ignore if already exist)
...
-- Drop payment_history table if it exists and recreate
